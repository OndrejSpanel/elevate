...
export class VirtualPartnerModifier implements IModifier {
    ...
    public modify(): void {
		...
		view.prototype.render = function () {
			...
			const exportButtonHtml: string = "<a class=\"btn-block btn-xs button raceshape-btn btn-primary stravistix_exportVpu\" id=\"stravissimo_exportVpu\">Export this Segment Effort to your GPS</a>";
