...
export class ActivityComputer {
	...
	protected moveData(velocityArray: number[], timeArray: number[], gradeArray: number[]): MoveDataModel {
        ...
        for (let i: number = 0; i < velocityArray.length; i++) { // Loop on samples
            ...
            if (i > 0) {
                ...
                if (currentSpeed > 0) { // If moving...
                    ...
                    let forSum = this.discreteValueBetween(velocityArray[i] * 3.6, velocityArray[i - 1] * 3.6, movingSeconds);
